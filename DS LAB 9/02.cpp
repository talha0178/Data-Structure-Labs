...
/*The following program is the implementation of AVL trees insertion, deletion operations also it checks if the current tree
is AVL or not. In addition to this the program is also capable of displaying the tree.*/
...
public:
    ...
    TreeNode* deleteNode(TreeNode* r, int v) {
       ...
       //It only displays the result and calls chkAVL
        void AvlOrNot(TreeNode* r)
        {
            chkAVL(r);
            if (ifAVL == true)
                cout << "\nThe following BST is AVL" << endl;
            else
                cout << "The followning tree is not AVL" << endl;
        }
